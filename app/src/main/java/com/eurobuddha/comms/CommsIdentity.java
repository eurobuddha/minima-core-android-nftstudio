...
public final class CommsIdentity {
    ...
    /** HKDF domain for THIS app family. miniMall uses "minimerch-*" so the same seed yields a DIFFERENT
     *  identity than the Mail app ("minima-comms-*") — one node can run both with no key clash. */
    private static final String APP_CONTEXT = "minimerch";
